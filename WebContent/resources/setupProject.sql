...
VALUES (seq_coupon.nextval, '70D20530', 000001, '40% Off Any One Item', 'Save 40% off any one regular priced item', 'Limit one coupon per product. Limit one coupon of each type per day', 'PERCENT', 40.00, SYSDATE, SYSDATE + 7);
INSERT INTO COUPON (c_id, c_code, c_store_id, c_title, c_description, c_restriction, c_disc_type, c_disc_amt, c_start_date, c_end_date)
VALUES (seq_coupon.nextval, '9BE9DEE4', 000001, '20% Off', 'All regular priced items', 'Limit one coupon per product. Limit one coupon of each type per day', 'PERCENT', 20.00, SYSDATE, SYSDATE + 7);
INSERT INTO COUPON (c_id, c_code, c_store_id, c_title, c_description, c_restriction, c_disc_type, c_disc_amt, c_start_date, c_end_date)
